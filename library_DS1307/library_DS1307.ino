...
//  Wire.begin();
  Serial.begin(9600);
  pinMode(A3, OUTPUT);     //*** pin 17 (Analog pin 3) as OUTPUT   ***
  digitalWrite(A3, HIGH);   //*** pin 17 (Analog pin 3) set to HIGH ***
  pinMode(A2, OUTPUT);     //*** pin 16 (Analog pin 2) as OUTPUT   ***
  digitalWrite(A2, LOW);  //*** pin 16 (Analog pin 2) set to LOW  ***
